...
def create_strategy_tab(self):
    ...
    batch_layout.setSpacing(tokens.SPACE_XS)

    self.btn_batch_sell = QPushButton("일괄 매도")
    self.btn_batch_sell.setMinimumSize(120, tokens.CONTROL_HEIGHT_MD)
    self.btn_batch_sell.setProperty("destructive", True)
    ...
    self.btn_batch_buy.setMinimumSize(120, tokens.CONTROL_HEIGHT_MD)
    self.btn_batch_buy.setProperty("primary", True)
    ...
    btn_layout.setSpacing(tokens.SPACE_XS)
    ...
    self.btn_stop = QPushButton("매매 중지")
